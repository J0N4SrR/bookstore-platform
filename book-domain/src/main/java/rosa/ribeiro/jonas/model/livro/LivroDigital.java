...
public class LivroDigital extends Livro {
    ...
    public LivroDigital(String titulo, String isbn, int numPaginas, int anoPublicacao, String resumo, int quantidadeEstoque, BigDecimal precoBase, EditoraModel editoraModel, List<AutorModel> autores, Set<CategoriaModel> categoriaModels) {
